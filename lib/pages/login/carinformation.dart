                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  if (transportType != '' ||
                                                    ...
                                                    if (myServiceId != tempServiceLocationId && serviceConfirmed == true) {
                                                      print('Debug: Condition entered.');
                                                      print('myServiceId: $myServiceId');
                                                      print('tempServiceLocationId: $tempServiceLocationId');
                                                      print('serviceConfirmed: $serviceConfirmed');
                                                      ...
                                                      print('Debug: Before calling getvehicleType().');
                                                      var result = await getvehicleType();
                                                      print('Debug: Result from getvehicleType(): $result');

                                                      if (result != 'success') {
                                                        _error = result;
                                                        print('Debug: Error occurred: $_error');
                                                      } else {
                                                        print('Debug: Clearing vehicle type selections.');
                                                        choosevehicletypelist.clear();
                                                        mycustommake = '';
                                                        ...
                                                        vehicleMakeId = '';
                                                        vehicleModelId = '';
                                                        print('Debug: Successfully updated vehicle type.');
                                                      }
