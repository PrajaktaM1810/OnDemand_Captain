...
import 'package:flutter_driver/pages/NavigatorPages/reward_history.dart';
import 'package:flutter_driver/pages/NavigatorPages/request_list.dart';
import 'package:flutter_driver/pages/NavigatorPages/settings.dart';
import 'package:flutter_driver/pages/NavigatorPages/subscription_history.dart';
...
import '../NavigatorPages/subscription_list.dart';
import '../NavigatorPages/target.dart';
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: NavMenu(
                                ...
                                text: languages[choosenLanguage]['text_rent_request'],
                                icon: Icons.list,
                              ),
                            ),
                            ...
                            SizedBox(
                              ...
                              child: NavMenu(
                                ...
                                text: languages[choosenLanguage]['text_subscription_list'],
                            ...
                            SizedBox(
                              ...
                              child: NavMenu(
                                ...
                                text: languages[choosenLanguage]['text_subscription_history'],
                              ...
                              child: NavMenu(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const TargetList(),
                                    ),
                                  );
                                },
                                text: languages[choosenLanguage]['text_target_list'],
                            ...
                            SizedBox(
                              ...
                              child: NavMenu(
                                ...
                                text: languages[choosenLanguage]['text_reward_history'],
                                icon: Icons.history,
                              ),
                            ),
